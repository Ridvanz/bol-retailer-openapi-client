...
class TestAudioTracks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AudioTracks:
        """Test AudioTracks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AudioTracks`
        """
        model = AudioTracks()
        if include_optional:
            return AudioTracks(
