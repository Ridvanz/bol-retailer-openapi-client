...
class TestPickupAppointment(unittest.TestCase):
    """PickupAppointment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PickupAppointment:
        """Test PickupAppointment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickupAppointment`
        """
    ...
    def testPickupAppointment(self):
        """Test PickupAppointment"""
