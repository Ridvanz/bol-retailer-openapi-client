...
class TestPerformanceIndicators(unittest.TestCase):
    """PerformanceIndicators unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PerformanceIndicators:
        """Test PerformanceIndicators
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PerformanceIndicators`
        """
        model = PerformanceIndicators()
        if include_optional:
            return PerformanceIndicators(
                performance_indicators = [
                    openapi_client.models.performance_indicator.PerformanceIndicator(
                        name = 'CANCELLATIONS', 
                        type = 'PERCENTAGE', 
