...
class TestCommissionSuccessfulQuery(unittest.TestCase):
    """CommissionSuccessfulQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommissionSuccessfulQuery:
        """Test CommissionSuccessfulQuery
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommissionSuccessfulQuery`
        """
        model = CommissionSuccessfulQuery()
        if include_optional:
            return CommissionSuccessfulQuery(
                index = 0,
                status = 200,
                commission_rates = [
    ...
    def testCommissionSuccessfulQuery(self):
        """Test CommissionSuccessfulQuery"""
