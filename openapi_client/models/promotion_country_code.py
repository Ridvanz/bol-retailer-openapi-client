...
class PromotionCountryCode(BaseModel):
    """
    PromotionCountryCode
    """ # noqa: E501
    country_code: StrictStr = Field(description="The country code of the country in which the promotion is active.", alias="countryCode")
