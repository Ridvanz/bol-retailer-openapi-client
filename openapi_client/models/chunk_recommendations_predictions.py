...
class ChunkRecommendationsPredictions(BaseModel):
    """
    ChunkRecommendationsPredictions
    """ # noqa: E501
    predictions: List[ChunkRecommendationsPrediction]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "predictions": [ChunkRecommendationsPrediction.from_dict(_item) for _item in obj["predictions"]] if obj.get("predictions") is not None else None
        })
        return _obj
