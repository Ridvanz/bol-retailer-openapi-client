...
class ChunkRecommendationsResponse(BaseModel):
    """
    ChunkRecommendationsResponse
    """ # noqa: E501
    recommendations: List[ChunkRecommendationsPredictions]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recommendations": [ChunkRecommendationsPredictions.from_dict(_item) for _item in obj["recommendations"]] if obj.get("recommendations") is not None else None
        })
        return _obj
