...
class ReturnItem(BaseModel):
    ...
    title: StrictStr = Field(description="The product title.")
    ...
    track_and_trace: Optional[StrictStr] = Field(default=None, description="The track and trace code that is associated with this transport.", alias="trackAndTrace")
    transporter_name: Optional[StrictStr] = Field(default=None, description="The name of the transporter.", alias="transporterName")
    ...
    __properties: ClassVar[List[str]] = ["rmaId", "orderId", "ean", "title", "expectedQuantity", "returnReason", "trackAndTrace", "transporterName", "handled", "processingResults", "customerDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transporterName": obj.get("transporterName"),
            ...
            "customerDetails": CustomerDetails.from_dict(obj["customerDetails"]) if obj.get("customerDetails") is not None else None
        })
        return _obj
