...
class ProductLabelsProduct(BaseModel):
    """
    ProductLabelsProduct
    """ # noqa: E501
    ean: StrictStr = Field(description="The EAN number associated with this product.")
    quantity: Annotated[int, Field(le=9999, strict=True, ge=1)] = Field(description="The number of products to generate labels for.")
    __properties: ClassVar[List[str]] = ["ean", "quantity"]
