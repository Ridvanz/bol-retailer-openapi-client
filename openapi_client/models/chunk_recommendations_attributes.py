...
class ChunkRecommendationsAttributes(BaseModel):
    """
    ChunkRecommendationsAttributes
    """ # noqa: E501
    attributes: List[ChunkRecommendationsAttribute]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": [ChunkRecommendationsAttribute.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None
        })
        return _obj
