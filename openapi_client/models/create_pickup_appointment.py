...
class CreatePickupAppointment(BaseModel):
    """
    CreatePickupAppointment
    """ # noqa: E501
    address: CreateAddress
    pickup_time_slot: CreatePickupTimeSlot = Field(alias="pickupTimeSlot")
    ...
    __properties: ClassVar[List[str]] = ["address", "pickupTimeSlot", "commentToTransporter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address": CreateAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "pickupTimeSlot": CreatePickupTimeSlot.from_dict(obj["pickupTimeSlot"]) if obj.get("pickupTimeSlot") is not None else None,
