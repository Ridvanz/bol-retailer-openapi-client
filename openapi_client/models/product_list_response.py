...
class ProductListResponse(BaseModel):
    ...
    ProductListResponse
    """ # noqa: E501
    products: List[ProductListProduct] = Field(description="The list of products that is associated with the given search term or category and filters.")
    sort: StrictStr = Field(description="Determines the order of the products.")
    __properties: ClassVar[List[str]] = ["products", "sort"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "products": [ProductListProduct.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None,
            "sort": obj.get("sort")
        })
        return _obj
