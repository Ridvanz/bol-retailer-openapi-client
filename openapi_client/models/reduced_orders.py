...
class ReducedOrders(BaseModel):
    """
    Container for many orders.
    """ # noqa: E501
    orders: List[ReducedOrder]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orders": [ReducedOrder.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
