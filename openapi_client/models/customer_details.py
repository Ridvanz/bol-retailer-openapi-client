...
class CustomerDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["salutation", "firstName", "surname", "streetName", "houseNumber", "houseNumberExtension", "extraAddressInformation", "zipCode", "city", "countryCode", "email", "deliveryPhoneNumber", "company", "vatNumber"]
