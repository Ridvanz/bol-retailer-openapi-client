...
class Promotions(BaseModel):
    ...
    """ # noqa: E501
    promotions: Optional[List[ReducedPromotion]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "promotions": [ReducedPromotion.from_dict(_item) for _item in obj["promotions"]] if obj.get("promotions") is not None else None
        })
        return _obj
