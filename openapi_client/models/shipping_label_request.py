...
class ShippingLabelRequest(BaseModel):
    ...
    """ # noqa: E501
    order_items: List[DeliveryOptionsRequestOrderItem] = Field(description="Order items for which the delivery options are requested.", alias="orderItems")
    shipping_label_offer_id: StrictStr = Field(description="Shipping label offer id for which you request a shipping label.", alias="shippingLabelOfferId")
    __properties: ClassVar[List[str]] = ["orderItems", "shippingLabelOfferId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orderItems": [DeliveryOptionsRequestOrderItem.from_dict(_item) for _item in obj["orderItems"]] if obj.get("orderItems") is not None else None,
