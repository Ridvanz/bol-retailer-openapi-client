...
class CommissionDateRate(BaseModel):
    """
    An array of objects, each describing commission rates for a specific condition.
    """ # noqa: E501
    condition: StrictStr = Field(description="Condition of the product.")
    price_ranges: List[CommissionPriceRange] = Field(alias="priceRanges")
    __properties: ClassVar[List[str]] = ["condition", "priceRanges"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.price_ranges:
            for _item in self.price_ranges:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "priceRanges": [CommissionPriceRange.from_dict(_item) for _item in obj["priceRanges"]] if obj.get("priceRanges") is not None else None
        })
        return _obj
