...
class CancellationRequest(BaseModel):
    ...
    """ # noqa: E501
    order_items: Annotated[List[OrderItemCancellation], Field(min_length=1, max_length=1)] = Field(description="List of order items to cancel. Order item id's must belong to the same order.", alias="orderItems")
    __properties: ClassVar[List[str]] = ["orderItems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orderItems": [OrderItemCancellation.from_dict(_item) for _item in obj["orderItems"]] if obj.get("orderItems") is not None else None
        })
        return _obj
