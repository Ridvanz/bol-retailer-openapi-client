...
class BillingDetails(BaseModel):
    ...
    email: StrictStr = Field(description="A scrambled email address that can be used to contact the customer.")
    ...
    order_reference: Optional[StrictStr] = Field(default=None, description="The order reference specified by the customer when ordering a product.", alias="orderReference")
    __properties: ClassVar[List[str]] = ["salutation", "firstName", "surname", "streetName", "houseNumber", "houseNumberExtension", "extraAddressInformation", "zipCode", "city", "countryCode", "email", "company", "vatNumber", "kvkNumber", "orderReference"]
