...
class ProductListProduct(BaseModel):
    """
    The list of products that is associated with the given search term or category and filters.
    """ # noqa: E501
    title: StrictStr = Field(description="The title of the product.")
    eans: List[ProductListProductEan]
    __properties: ClassVar[List[str]] = ["title", "eans"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "eans": [ProductListProductEan.from_dict(_item) for _item in obj["eans"]] if obj.get("eans") is not None else None
        })
        return _obj
