...
class Filters(BaseModel):
    ...
    """ # noqa: E501
    filter_name: StrictStr = Field(description="The name of the filter.", alias="filterName")
    filter_values: List[FilterValues] = Field(description="The list of filter values in this filter.", alias="filterValues")
    __properties: ClassVar[List[str]] = ["filterName", "filterValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filterValues": [FilterValues.from_dict(_item) for _item in obj["filterValues"]] if obj.get("filterValues") is not None else None
        })
        return _obj
