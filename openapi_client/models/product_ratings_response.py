...
class ProductRatingsResponse(BaseModel):
    ...
    """ # noqa: E501
    ratings: List[ProductRatingsRating]
    __properties: ClassVar[List[str]] = ["ratings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ratings": [ProductRatingsRating.from_dict(_item) for _item in obj["ratings"]] if obj.get("ratings") is not None else None
        })
        return _obj
